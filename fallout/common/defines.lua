...
country = {
	...
	MOBILIZATION_SPEED_BASE = 0.24, -- Base speed for raising troops was 0.12
...
military = {
	...
	AI_ARMY_TAXBASE_FRACTION = 1.0, -- max of tax base that AI will spend on army supply costs (based on peacetime costs)
	...
	SIEGE_BRIGADES_BONUS = 2.0, -- the bonus to siege speed from each brigade                                         WAS 0.5
	RECON_SIEGE_EFFECT = 1.0, -- multiplier to effect of recon on speeding up sieges
...
diplomacy = {
	...
	LARGE_POPULATION_INFLUENCE_PENALTY = 0.0,
...
pops = {
	...
	LITERACY_CHANGE_SPEED = 0.5, -- was 0.1


	ASSIMILATION_SCALE = 0.020, -- was 0.004
...
ai =
{
	...
	PEACE_BASE_RELUCTANCE = 10000, -- AI base stubbornness to refuse peace (always applied)                                                              was 20
	PEACE_TIME_MONTHS = 3000, -- months of additional AI stubbornness in a war
